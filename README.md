# Magento 2 Orders Export and Import Extension

[Magento 2 Orders Export and Import](https://www.ulmod.com/orders-export-and-import-for-magento-2.html)  is a Magento 2 extension that allows you to export and import customers and guest orders including all related orders, customer, and product data.

With Magento 2 Orders Export and Import, you easily transfer orders between Magento 2 sites or installations.

<a href="https://www.ulmod.com/orders-export-and-import-for-magento-2.html"><img width="205" src="https://www.ulmod.com/media/wysiwyg/um-download-now1.png"></a>

## Key Features

* Export and import any number of orders in a CSV file
* Export and import orders including all related information, such as order & account information, 
 payment & shipping method, address information, items ordered,  shipping tracking information,  order status, comments, and more
* Ability to optionally create invoices, shipments, and credit memo(s) during the order import
* Export and import orders for a specified date 
* Supports custom order number and custom order status
* Supports all product types 
* Ability to import and export orders via the command line(CLI)
* Support single and bulk/multiple CSV files imports via the command line (CLI)
* Ability to import and export orders automatically via cron job
* Support orders export and import history. Manage all exports and import logs from the backend
* Ability to delete export and import history manually or automatically
* Support multiple currencies
* Support multi-stores


<img src="https://www.ulmod.com/media/wysiwyg/expimpords-export3.png">
<img src="https://www.ulmod.com/media/wysiwyg/expimpords-import3.png">
